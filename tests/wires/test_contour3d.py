...
class TestContour3D(unittest.TestCase):
    ...
    def test_merge_with(self):
        ...
        contour1 = Contour3D.load_from_file('/Users/wirajandasilva/Downloads/contour1_merge_bug.json')
        contour2 = Contour3D.load_from_file('/Users/wirajandasilva/Downloads/contour2_merge_bug.json')
