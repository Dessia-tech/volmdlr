...
class TestWire(unittest.TestCase):
    def test_extract_primitives(self):
        ...
        prim_true = contours.contour2d_1.extract_primitives(
            point1, contours.contour2d_1.primitives[3], point2, contours.contour2d_1.primitives[3], inside=True
        )

        prims_false = contours.contour2d_1.extract_primitives(
            point1, contours.contour2d_1.primitives[3], point2, contours.contour2d_1.primitives[3], inside=False
        )

        self.assertAlmostEqual(volmdlr.wires.Wire2D(prim_true).length(), 0.002002125855992895)
        self.assertAlmostEqual(volmdlr.wires.Wire2D(prims_false).length(), 0.0797864911978587)
