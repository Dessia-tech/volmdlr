...
class TestEllipse2D(unittest.TestCase):
    ...
    def test_line_intersections(self):
        ...
        self.assertEqual(line_intersections[0], volmdlr.Point2D(-2.1009029257555607,
                                                                -3.151354388633341))
        self.assertEqual(line_intersections[1], volmdlr.Point2D(2.1009029257555607,
                                                                3.151354388633341))
    ...
    def test_linesegment_intersections(self):
        ...
        self.assertEqual(linesegment_intersections[0], volmdlr.Point2D(2.82842712474619,
                                                                       2.82842712474619))
