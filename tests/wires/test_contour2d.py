...
class TestContour2D(unittest.TestCase):
    ...
    not_ordered_contour = dc.DessiaObject.load_from_file('wires/contour_not_ordered.json')
    ordered_contour = dc.DessiaObject.load_from_file('wires/contour_ordered.json')
    ...
    def test_offset(self):
        contour_to_offset = dc.DessiaObject.load_from_file('wires/contour_to_offset.json')
