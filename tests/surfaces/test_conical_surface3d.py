...
class TestConicalSurface3D(unittest.TestCase):
    ...
    def test_face_from_contours(self):
        buggy_conical_surface = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/conical_surface1.json')
        buggy_contours3d1 = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/face_from_contours1_0.json')
        buggy_contours3d2 = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/face_from_contours1_1.json')
        ...
        buggy_conical_surface = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/conical_surface3d_1.json')
        buggy_contours3d1 = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/face_contour1.json')
        buggy_contours3d2 = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/face_contour2.json')
        ...
        buggy_conical_surface = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/conical_surface3d_2.json')
        buggy_contours3d1 = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/face_contour3_.json')
        buggy_contours3d2 = dessia_common.core.DessiaObject.load_from_file(
            'surfaces/objects_conical_tests/face_contour4_.json')
        ...
        buggy_conical_surface = surfaces.ConicalSurface3D.load_from_file(
            "surfaces/objects_conical_tests/conical_surface_with_singularity.json")
        buggy_contours3d = vmw.Contour3D.load_from_file(
            'surfaces/objects_conical_tests/conical_contour_with_singularity.json')
