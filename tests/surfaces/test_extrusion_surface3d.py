...
class TestExtrusionSurface3D(unittest.TestCase):
    ...
    def test_contour3d_to_2d(self):
        ...
        surface = surfaces.SphericalSurface3D.load_from_file(
            "surfaces/objects_extrusion_tests/extrusionsurface_edge_not_in_normal_plane.json")
        contour = vmw.Contour3D.load_from_file(
            "surfaces/objects_extrusion_tests/extrusionsurface_edge_not_in_normal_plane_contour.json")
        contour2d = surface.contour3d_to_2d(contour)
        self.assertTrue(contour2d.is_ordered())
