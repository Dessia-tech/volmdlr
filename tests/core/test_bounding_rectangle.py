...
class TestBoundingRectangle(unittest.TestCase):
    def setUp(self):
        ...
        self.ymin = -2
        self.ymax = 8
        self.br = volmdlr.core.BoundingRectangle(self.xmin, self.xmax, self.ymin, self.ymax)
    ...
    def test_distance_to_b_rectangle(self):
        ...
        br3 = volmdlr.core.BoundingRectangle(-4, -1, -5, -2)
        self.assertEqual(self.br.distance_to_b_rectangle(br3), 1)
        br4 = volmdlr.core.BoundingRectangle(7, 10, 9, 10)
