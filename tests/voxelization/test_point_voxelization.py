...
class TestPointVoxelizationCreation(unittest.TestCase):
    ...
    def test_voxelize_block(self):
        block_voxelization = PointVoxelization.from_shell(self.block, 0.2, name="voxelization")
    ...
    def test_voxelize_translated_block(self):
        ...
        translated_block_voxelization = PointVoxelization.from_shell(translated_block, 0.1, name="voxelization")
    ...
    def test_voxelize_sphere(self):
        sphere_voxelization = PointVoxelization.from_shell(self.sphere, 0.01, name="sphere voxelization")
    ...
    def test_voxelize_cylinder(self):
        cylinder_voxelization = PointVoxelization.from_shell(self.cylinder, 0.01, name="cylinder voxelization")
...
class TestPointVoxelizationBooleanOperation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sphere_voxelization = PointVoxelization.from_shell(self.sphere, 0.01, name="sphere voxelization")
        self.cylinder_voxelization = PointVoxelization.from_shell(self.cylinder, 0.01, name="cylinder voxelization")
...
class TestPointVoxelizationManipulation(unittest.TestCase):
    ...
    def test_translation(self):
        ...
        self.assertEqual(translated_cylinder_voxelization, PointVoxelization.from_shell(translated_cylinder, 0.01))
