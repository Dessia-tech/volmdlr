...
class TestVoxelMatrixCreation(unittest.TestCase):
    ...
    def test_voxelize_block(self):
        block_voxelization = VoxelMatrix.from_closed_shell(self.block, 0.2, name="voxelization")
    ...
    def test_voxelize_translated_block(self):
        ...
        translated_block_voxelization = VoxelMatrix.from_closed_shell(translated_block, 0.1, name="voxelization")
    ...
    def test_voxelize_sphere(self):
        sphere_voxelization = VoxelMatrix.from_closed_shell(self.sphere, 0.01, name="sphere voxelization")
    ...
    def test_voxelize_cylinder(self):
        cylinder_voxelization = VoxelMatrix.from_closed_shell(self.cylinder, 0.01, name="cylinder voxelization")
...
class TestVoxelMatrixBooleanOperation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sphere_voxelization = VoxelMatrix.from_closed_shell(self.sphere, 0.01, name="sphere voxelization")
        self.cylinder_voxelization = VoxelMatrix.from_closed_shell(self.cylinder, 0.01, name="cylinder voxelization")
    ...
    def test_symmetric_difference(self):
        ...
        self.assertEqual(3896, len(symmetric_difference_1))
...
class TestVoxelMatrixManipulation(unittest.TestCase):
    ...
    def test_inverse(self):
        ...
        self.assertEqual(6420, len(inverse_cylinder_voxelization))
    ...
    def test_translation(self):
        ...
        self.assertEqual(translated_cylinder_voxelization, VoxelMatrix.from_closed_shell(translated_cylinder, 0.01))
    ...
    def test_fill_enclosed_voxels(self):
        ...
        self.assertEqual(7644, len(inner_filled_voxelization))
