...
class TestCylindricalFace3D(unittest.TestCase):
    ...
    def test_linesegment_intersections(self):
        lineseg3d = edges.LineSegment3D(volmdlr.O3D, volmdlr.Point3D(0.3, 0.3, 0.3))
        ...
        lineseg3d_2 = edges.LineSegment3D(volmdlr.Point3D(-0.3, -0.3, -0.1), volmdlr.Point3D(0.3, 0.3, 0.3))
        line_inters_2 = cylindrical_face1.linesegment_intersections(lineseg3d_2)
        self.assertEqual(len(line_inters_2), 2)
        self.assertEqual(line_inters_2[0], volmdlr.Point3D(0.2262741, 0.2262741, 0.2508494))
        self.assertEqual(line_inters_2[1], volmdlr.Point3D(-0.2262741, -0.2262741, -0.0508494))
