...
class TestLine2D(unittest.TestCase):
    ...
    def test_sort_points_along_line(self):
        ...
        list_points2d = [volmdlr.Point2D(2, 4), volmdlr.Point2D(1.5, 3), volmdlr.Point2D(4, 8), volmdlr.Point2D(2.5, 5)]
        sorted_points_along_line2d = line2d.sort_points_along_line(list_points2d)
        expected_sorted_points2d = [
            volmdlr.Point2D(1.5, 3),
            volmdlr.Point2D(2, 4),
            volmdlr.Point2D(2.5, 5),
            volmdlr.Point2D(4, 8),
        ]
