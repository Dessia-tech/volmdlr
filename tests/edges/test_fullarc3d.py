...
class TestFullArc3D(unittest.TestCase):
    fullarc3d = edges.FullArc3D(volmdlr.Point3D(0.0, 0.0, -0.25), volmdlr.Point3D(0.15, 0.0, -0.25),
    ...
    def test_linesegment_intersections(self):
        ...
        self.assertEqual(linesegment_intesections1[0],
                         volmdlr.Point3D(0.10606601717798213, 0.10606601717798214, -0.25))
        self.assertEqual(linesegment_intesections1[1],
