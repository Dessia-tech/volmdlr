...
class TestArcEllipse3D(unittest.TestCase):
    ...
    def test_arc_intersections(self):
        ...
        expected_intersections1 = [volmdlr.Point3D(1.354577913713, 0.964620364538, 0.964620364538),
                                   volmdlr.Point3D(1.393846848023, 0.527821436653, 0.527821436653),
                                   volmdlr.Point3D(-0.239145968544, -1.105171585562, -1.105171585562),
                                   volmdlr.Point3D(-0.83463441314, -1.224592065711, -1.224592065711)]
