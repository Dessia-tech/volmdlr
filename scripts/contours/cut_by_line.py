...
infinit_line1 = vme.Line2D(bspline_middle_point, bspline_tangent)
infinit_line2 = vme.Line2D(bspline.point_at_abscissa(bspline.length() * 0.73), volmdlr.Point2D(-0.8, 1))
infinit_line3 = vme.Line2D(bspline_middle_point, volmdlr.Point2D(2, 2))
