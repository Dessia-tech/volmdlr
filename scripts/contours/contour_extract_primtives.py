...
primitives = [
    volmdlr.edges.LineSegment2D(volmdlr.Point2D(0.001, 0.014), volmdlr.Point2D(0.001, 0.0125)),
    volmdlr.edges.Arc2D(
    ...
    volmdlr.edges.LineSegment2D(volmdlr.Point2D(-0.001, 0.0125), volmdlr.Point2D(-0.001, 0.014)),
    volmdlr.edges.LineSegment2D(volmdlr.Point2D(-0.001, 0.014), volmdlr.Point2D(0.001, 0.014)),
]
...
extracted_primitives_inside_true = contour2d.extract_primitives(
    point1, contour2d.primitives[3], point2, contour2d.primitives[3], inside=True
)

extracted_primitives_inside_false = contour2d.extract_primitives(
    point1, contour2d.primitives[3], point2, contour2d.primitives[3], inside=False
)
