"""
Showcase of surface interference computing using octree voxelization.
"""
import math
import time
...
voxelization = OctreeBasedVoxelization.from_volume_model(volume_model, VOXEL_SIZE)
voxelization_moved = OctreeBasedVoxelization.from_volume_model(moved_volume_model, VOXEL_SIZE)
