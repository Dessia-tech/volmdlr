...
R1, R2 = (
    random.randrange(rmin, rmax, 1) / 1000,
    random.randrange(rmin, rmax, 1) / 1000,
)  # Radius of the generative arc3D
r1, r2 = (
...
pt1_2, pt2_2, pt3_2, pt4_2 = (
    volmdlr.Point2D((offset_theta2, offset_phi2)),
    volmdlr.Point2D((offset_theta2, offset_phi2 + phi2)),
    volmdlr.Point2D((offset_theta2 + theta2, offset_phi2 + phi2)),
    volmdlr.Point2D((offset_theta2 + theta2, offset_phi2)),
)
seg1_2, seg2_2, seg3_2, seg4_2 = (
    volmdlr.LineSegment2D(pt1_2, pt2_2),
    volmdlr.LineSegment2D(pt2_2, pt3_2),
    volmdlr.LineSegment2D(pt3_2, pt4_2),
    volmdlr.LineSegment2D(pt4_2, pt1_2),
)
