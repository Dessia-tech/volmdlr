...
pt1, pt2, pt3, pt4 = (
    vm.Point2D((offset_theta, offset_phi)),
    vm.Point2D((offset_theta, offset_phi + phi)),
    vm.Point2D((offset_theta + theta, offset_phi + phi)),
    vm.Point2D((offset_theta + theta, offset_phi)),
)
seg1, seg2, seg3, seg4 = (
    vm.LineSegment2D(pt1, pt2),
