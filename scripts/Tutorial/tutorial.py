...
profile1 = primitives3D.Cylinder(
    position=vm.Point3D(-0.0075, 0.14, 0.25), axis=vm.X3D, radius=0.02, length=0.015, name="profile1"
)

profile2 = primitives3D.Cylinder(
    position=vm.Point3D(-0.0075, 0.19, 0.25), axis=vm.X3D, radius=0.02, length=0.015, name="profile2"
)

profile3 = primitives3D.Cylinder(
    position=vm.Point3D(-0.0075, 0.15, 0.08), axis=vm.X3D, radius=0.08, length=0.015, name="profile3"
)
...
profile4 = primitives3D.RevolvedProfile(
    vm.Z3D * 0.08 - 0.015 * vm.Y3D, vm.X3D, z, c5, vm.Z3D * 0.08 - 0.015 * vm.Y3D, vm.X3D
)
profile5 = primitives3D.RevolvedProfile(
    vm.Z3D * 0.22 + 0.035 * vm.Y3D, vm.X3D, z, c5, vm.Z3D * 0.22 + 0.035 * vm.Y3D, vm.X3D
)
