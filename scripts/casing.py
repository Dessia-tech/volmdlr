...
screw_holes_rl = inner_rl.Offset(-(thickness+screw_holes_clearance + 0.5 * screw_holes_diameter))
screw_holes = []
...
belt_outer_rl = inner_rl.Offset(-(2*screw_holes_clearance + screw_holes_diameter+thickness))
