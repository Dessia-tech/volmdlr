...
edges = [
    volmdlr.edges.LineSegment2D(vm.Point2D(0, 0), vm.Point2D(0.1, 0.0)),
    volmdlr.edges.LineSegment2D(vm.Point2D(0.1, 0.0), vm.Point2D(0.1, 0.2)),
    volmdlr.edges.Arc2D(start=vm.Point2D(0.1, 0.2), end=vm.Point2D(0.0, 0.2), interior=vm.Point2D(0.05, 0.25)),
    volmdlr.edges.LineSegment2D(vm.Point2D(0.0, 0.2), vm.Point2D(0, 0)),
]
