...
poly_1 = vmw.ClosedPolygon3D(
    [
        vm.Point3D(-0.3, 0.05, -0.20),
...
faces1 = (
    [vmf.Triangle3D(*points) for points in new_poly_11.sewing(new_poly_12, vm.X3D, vm.Y3D)]
    + [vmf.Triangle3D(*points) for points in new_poly_12.sewing(new_poly_13, vm.X3D, vm.Y3D)]
    + [vmf.Triangle3D(*points) for points in new_poly_13.sewing(new_poly_14, vm.X3D, vm.Y3D)]
)
...
faces2 = (
    [vmf.Triangle3D(*points) for points in new_poly_21.sewing(new_poly_22, vm.X3D, vm.Z3D)]
    + [vmf.Triangle3D(*points) for points in new_poly_23.sewing(new_poly_22, vm.X3D, vm.Z3D)]
    + [vmf.Triangle3D(*points) for points in new_poly_23.sewing(new_poly_24, vm.X3D, vm.Z3D)]
)
