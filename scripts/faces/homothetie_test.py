...
stl = vms.Stl.from_file(
    "C:\\Users\\Mack_Pro\\Documents\\git\\Renault\\DynamicLoop\Mise a jour GMP S30\\jeu2\\forbi_disc\\new_HR18 FDU piece chaude.stl"
)
...
res_x = minimize(homothetie_x, (2), options={"eps": 1e-6})

res_y = minimize(homothetie_y, (2), options={"eps": 1e-6})

res_z = minimize(homothetie_z, (2), options={"eps": 1e-6})
...
vol = volmdlr.core.VolumeModel(
    [shell3d, new_shell_displaced, new_shell_displaced_x, new_shell_displaced_y, new_shell_displaced_z] + spheres
)
vol.babylonjs()
