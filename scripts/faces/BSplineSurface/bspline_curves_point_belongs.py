...
degree = 2
control_points = [
    vm.Point2D(0.0, 0.10000000000000002),
...
# Bspline_curve
bspline_curve2d = vm.edges.BSplineCurve2D(degree, control_points, knot_multiplicities, knots)


# %% Point-belongs

points2d = [
    vm.Point2D(0.18337173875665347, 0.29040613195152876),
    vm.Point2D(0.4, 0.5),
    vm.Point2D(0.5, 0.9),
...
ax.legend(handles=[mpatches.Patch(color="green", label="Belongs"), mpatches.Patch(color="red", label="Not")])
