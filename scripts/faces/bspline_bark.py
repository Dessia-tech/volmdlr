...
base_points1 = [vm.Point2D(0, 0), vm.Point2D(0.1, 0.05), vm.Point2D(0.2, 0.1), vm.Point2D(0.2, 0.3)]
...
base_points2 = [vm.Point2D(0, 0), vm.Point2D(-0.1, 0.05), vm.Point2D(-0.2, 0.13), vm.Point2D(-0.2, 0.25)]
