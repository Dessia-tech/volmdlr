...
box_green = box_red.frame_mapping(
    vm.Frame3D(vm.Point3D(-0.4, 0, -0.1), vm.Vector3D(1, 0, 0), vm.Vector3D(0, 1, 0), vm.Vector3D(0, 0, 1)), "new"
)
...
box_blue = primitives3D.Block(
    vm.Frame3D(vm.Point3D(0.1, 0, 0), vm.Vector3D(0.2, 0, 0), vm.Vector3D(0, 0.1, 0), vm.Vector3D(0, 0, 1)), alpha=0.6
)
box_blue.color = (0.1, 0.1, 1)
box_blue.name = "box_blue"

box_blue2 = box_blue.frame_mapping(
    vm.Frame3D(vm.Point3D(0.2, 0, 0), vm.Vector3D(1, 0, 0), vm.Vector3D(0, 1.8, 0), vm.Vector3D(0, 0, 1)), "old"
)
...
block1 = primitives3D.Block(
    frame=vm.Frame3D(
        origin=vm.Point3D(0.2, 0.6, 0.2), u=vm.Point3D(0.4, 0, 0), v=vm.Point3D(0, 1.2, 0), w=vm.Point3D(0, 0, 0.4)
    ),
    color=(1, 0.2, 0.1),
    alpha=0.6,
)
block2 = primitives3D.Block(
    frame=vm.Frame3D(
        origin=vm.Point3D(0.8 + 0.4, 0.45 + 0.15, 0.1),
...
block3 = primitives3D.Block(
    frame=vm.Frame3D(
        origin=vm.Point3D(0.8 + 0.4, 0.45 + 0.15, 0.05),
        u=vm.Point3D(1.6, 0, 0),
        v=vm.Point3D(0, 0.9, 0),
        w=vm.Point3D(0, 0, 0.2),
    ),
