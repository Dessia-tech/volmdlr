...
scripts = [
    ...
    # Voxelization
    "discrete/voxelization/interference/interference_surface_showcase.py",
    "discrete/voxelization/interference/interference_volume_showcase.py",
    "discrete/voxelization/step_file_voxelization.py",
    "discrete/voxelization/stl_file_voxelization.py",
    "discrete/voxelization/volume_model_matrix_based_voxelization.py",
    "discrete/voxelization/volume_model_point_based_voxelization.py",
    "discrete/voxelization/voxelization_filling.py",
    "discrete/voxelization/voxelization_inverse.py",
    "discrete/voxelization/voxelization_moving.py",
    "discrete/voxelization/octree/inner_growing_showcase.py",
    "discrete/voxelization/octree/non_homogeneous_showcase.py",
    "discrete/voxelization/octree/intersecting_faces_combinations.py",
    # Pixelization
    "discrete/pixelization/pixelization_boolean_operations.py",
    "discrete/pixelization/pixelization_filling.py",
    "discrete/pixelization/pixelization_from_closed_polygon.py",
    "discrete/pixelization/pixelization_inverse.py",
    # Others
    "grid.py",
]
