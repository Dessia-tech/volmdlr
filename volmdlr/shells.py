...
from typing import Iterable, List, Tuple, Union, Optional, Any, Dict
...
class Shell(Shape):
    ...
    def __init__(self, obj: TopoDS_Shell, name: str = ''):
        self._faces = None
        self._bbox = None
        Shape.__init__(self, obj=obj, name=name)

    def __init__(self, faces: List[volmdlr.faces.Face3D], name: str = ''):
        self._faces = None
        self._bbox = None
        obj = self.from_faces(faces)
        Shape.__init__(self, obj=obj, name=name)
