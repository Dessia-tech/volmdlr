...
class Primitive3D(dc.DessiaObject):
    def __init__(self, basis_primitives=None, color=None, alpha=0.5, name=''):
        self.color = color
        self.alpha = alpha
        self.name = name
...
class Plane3D(Primitive3D):
    def __init__(self, frame: Frame3D, name: str = ''):
        """
    ...
    def from_3_points(cls, point1, point2, point3):
        ...
        frame = Frame3D(point1, vector1, normal.Cross(vector1), normal)
        return cls(frame)
    ...
    def from_normal(cls, point, normal):
        ...
        v2 = v1.Cross(normal)
        return cls(Frame3D(point, v1, v2, normal))
...
class ToroidalSurface3D(Primitive3D):
    ...
    def __init__(self, frame: Frame3D,
    ...
    def _bounding_box(self):
        ...
        return BoundingBox.from_points([p1, p2, p3, p4, p5, p6, p7, p8])
    ...
    def point2d_to_3d(self, point2d):
        ...
        return self.frame.OldCoordinates(Point3D([x, y, z]))
...
class Arc3D(Primitive3D):
    ...
    @classmethod
    def from_angle(cls, start: Point3D, angle: float,
                   axis_point: Point3D, axis: Vector3D):
        start_gen = start
    ...
    def revolution(self, axis_point, axis, angle):
        ...
        if u1.is_colinear_to(self.DirectionVector()):
            ...
            if angle == 2 * math.pi:
                ...
                # Two arcs and lines
                arc1_i = self.points[1].Rotation(axis=axis,
                                                 axis_point=axis_point,
                                                 angle=0.5 * angle)
                arc1_e = self.points[1].Rotation(axis=axis,
                                                 axis_point=axis_point,
                                                 angle=angle)
                arc2_i = self.points[0].Rotation(axis=axis,
                                                 axis_point=axis_point,
                                                 angle=0.5 * angle)
                arc2_s = self.points[0].Rotation(axis=axis,
                                                 axis_point=axis_point,
                                                 angle=angle)

                arc1 = Arc3D(self.points[1], arc1_i, arc1_e)
                arc2 = Arc3D(arc2_s, arc1_i, self.points[0])
                line2 = LineSegment3D(arc1_e, arc2_s)
                outer_contour3d = Contour3D([self, arc1, line2, arc2])
                inner_contours3d = []
            return PlaneFace3D.from_contours3d(
            ...
            surface = ConicalSurface3D(Frame3D(p1_proj, axis, v, w),
                                       semi_angle)
...
class Circle3D(Contour3D):
    ...
    def __init__(self, frame: Frame3D, radius: float,
                 name: str = ''):
        """
    ...
    def outer_contour3d(self):
        ...
        for primitive2d in self.outer_contour2d.primitives:
            if primitive2d.__class__ == LineSegment2D:
                p1 = self.surface.point2d_to_3d(primitive2d.points[0])
                p2 = self.surface.point2d_to_3d(primitive2d.points[1])
...
class PlaneFace3D(Face3D):
    ...
    def __init__(self, plane3d, outer_contour2d, inner_contours2d, name=''):
        if not isinstance(outer_contour2d, Contour2D):
            print(outer_contour2d.primitives)
            raise ValueError
        print('init', outer_contour2d, outer_contour2d.primitives)
...
class CylindricalFace3D(Face3D):
    ...
    def from_arc3d(cls, lineseg, arc,
        ...
        return cls(cylindersurface3d, Contour2D(edges), [], name='')
...
class ToroidalFace3D(Face3D):
    ...
    @classmethod
    def from_contour3d(cls, contours3d, toroidalsurface3d, name: str = ''):
        """
        ...
        return cls.from_rectangular_cut(toroidalsurface3d, theta, phi)
