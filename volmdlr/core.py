...
class Tooltip(dc.DessiaObject):
    def __init__(self, colorfill: str, font: str, tp_width: float,
                 tp_radius: float, to_plot_list: list, name: str = ''):
    ...
    def plot_data(self,
        ...
        if plot_data_states is None:
            plot_data_states = [plot_data.PlotDataState()]
        return plot_data.PlotDataTooltip(colorfill=self.colorfill,
                                         font=self.font,
                                         tp_width=self.tp_width,
                                         tp_radius=self.tp_radius,
                                         to_plot_list=self.to_plot_list,
                                         plot_data_states=plot_data_states,
                                         name=self.name)
