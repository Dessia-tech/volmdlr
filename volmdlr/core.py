...
class ScatterPlot(dc.DessiaObject):
    def __init(self, nb_points_x:int, nb_points_y:int, font_size:int, name=''):
    ...
    def plot_data(self, plot_data_states:List[plot_data.PlotDataState]=None):
        if plot_data_states is None:
            plot_data_states = [plot_data.PlotDataState()]
        return plot_data.PlotDataScatterPlot(nb_points_x=self.nb_points_x, nb_points_y=self.nb_points_y, font_size=self.font_size, plot_data_states=plot_data_states)
