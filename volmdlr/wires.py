...
class Contour2D(ContourMixin, Wire2D):
    ...
    def to_polygon(self, angle_resolution, discretize_line: bool = False, discretize_line_direction: str = "xy"):
        """
        Transform the contour_mixin to a polygon.
        ...
        :param discretize_line_direction: Specify "x" or "y" if you want to discretize the line only in one of these
            directions. If not specified it will discretize the line segments in any direction
        :type discretize_line_direction: str
