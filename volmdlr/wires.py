...
class Contour2D(ContourMixin, Wire2D):
    ...
    def get_furthest_point_to_point2(self, point2):
        """
        Search the furthest point from self to point2. Only consider the start or end or primitives.
    ...
    def closest_point_to_point2(self, point2):
        """
        Search the closest point from self to point2. Only consider the start or end or primitives.
