        ...
        for primitive in self.primitives:
            if isinstance(primitive, volmdlr.edges.LineSegment2D):
                if not discretize_line:
                    ...
                    if discretize_line_direction == "xy" or (discretize_line_direction == "x" and is_horizontal) or \
                        (discretize_line_direction == "y" and is_vertical) or (not is_vertical and not is_horizontal):
