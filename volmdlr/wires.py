    ...
    def merge_primitives_with(self, contour):
        ...
        for i in range(1, len(points)+1, 2):
            ...
            merge_primitives_prim = self.extract_without_primitives(point1,
                                                                    point2,
                                                                    False)
            if contour.point_over_contour(merge_primitives_prim[0].middle_point()) is True: #point_at_abscissa(0.2)) is True:
                merge_primitives_prim = self.extract_without_primitives(point1,
                                                                        point2,
                                                                        True)
            ...
            merge_primitives_prim = contour.extract_without_primitives(point1,
                                                                         point2,
                                                                         False)
            if self.point_over_contour(merge_primitives_prim[0].middle_point()) is True: #point_at_abscissa(0.2)) is True:
                merge_primitives_prim = contour.extract_without_primitives(point1,
                                                                             point2,
                                                                             True)
                merge_primitives.extend(merge_primitives_prim)
