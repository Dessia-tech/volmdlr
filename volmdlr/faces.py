...
class PeriodicalSurfaces(Surface3D):
    def face_from_contours3d(self, contours3d: List[volmdlr.wires.Contour3D], name: str = ''):
        """
        Returns the face generated by a list of contours. Finds out which are outer or inner contours.
...
class CylindricalSurface3D(PeriodicalSurfaces):
    """
    ...
    def __init__(self, frame, radius, name=''):
        self.frame = frame
        self.radius = radius
        PeriodicalSurfaces.__init__(self, name=name)
...
class ToroidalSurface3D(PeriodicalSurfaces):
    """
...
class ConicalSurface3D(PeriodicalSurfaces):
    """
    The local plane is defined by (theta, z).
...
class BSplineFace3D(Face3D):
    ...
    def grid_size(self):
        ...
        # u_max_curvature = u.maximum_curvature()
        # v_max_curvature = v.maximum_curvature()
        # print(u_max_curvature, v_max_curvature)
