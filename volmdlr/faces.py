...
class Face3D(volmdlr.core.Primitive3D):
    ...
    def from_step(cls, arguments, object_dict, **kwargs):
        ...
        return face.from_surface_and_contours3d(surface, contours, name)

    @classmethod
    def from_surface_and_contours3d(cls, surface, contours3d: List[volmdlr.wires.Contour3D], name: str = ''):
        """
