...
cylindrical_surface = surfaces.CylindricalSurface3D(volmdlr.OXYZ.copy(), 0.32)
cylindrical_surface2 = surfaces.CylindricalSurface3D(volmdlr.OXYZ.copy(), 1.0)
...
cylindrical_surface4 = surfaces.CylindricalSurface3D(volmdlr.OXYZ.copy(), radius=0.03)
