...
class CylindricalSurface3D(PeriodicalSurface):
    ...
    #         local_cylindricalsurface = self.frame_mapping(self.frame, 'new')
    #         local_plane3d = plane3d.frame_mapping(self.frame, 'new')
    #         local_intersections = local_cylindricalsurface.concurrent_plane_intersection(local_plane3d)
    #         intersections = [intersection.frame_mapping(self.frame, 'old')
    ...
    #     inters_lineseg1 = self.line_intersections(lineseg1.line)
    #     inters_lineseg2 = self.linesegment_intersections(lineseg2.line)
    #     if not inters_lineseg1:
    #         return []
...
class BSplineSurface3D(Surface3D):
    ...
    def _repair_periodic_boundary_points(self, curve3d, points_2d, direction_periodicity):
        ...
        if direction_periodicity == 'x':
            i = 0
            min_bound, max_bound, _, _ = self.domain
        else:
            i = 1
            _, _, min_bound, max_bound = self.domain
